...
const banner = {
  'core.js': '// 绸缪 · 数据层与核心逻辑（常量、存储、重复规则、导入校验）',
  'ui.js': '// 绸缪 · 通用 UI 与页面渲染（今天/预告/日历/详情）',
  'editor.js': '// 绸缪 · 新建/编辑表单（chips、重复规则选择、自定义录音）',
  'reminder.js': '// 绸缪 · 到点提醒（轮询、全屏弹层、语音播报、铃声、贪睡）',
  'settings.js': '// 绸缪 · 设置页（导入导出、清空、离线语音包、主题与备份）',
  'main.js': '// 绸缪 · 启动装配（渲染、时钟、轮询、音频预热）',
};
