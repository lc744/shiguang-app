# Probe TCB API (tcb.tencentcloudapi.com) for WeChat cloud dev env visibility
...
$hostName = 'tcb.tencentcloudapi.com'; $service = 'tcb'; $version = '2018-06-08'; $region = 'ap-guangzhou'
...
function Invoke-Tcb([string]$action, [string]$payload){
...
Write-Host '--- TCB DescribeEnvs ---'
$r = Invoke-Tcb 'DescribeEnvs' '{"Limit":20}'
